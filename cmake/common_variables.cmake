...
if(OS_MACOSX)
  ...
  list(APPEND COMMON_CXX_COMPILER_FLAGS
    ...
    -fvisibility-inlines-hidden     # Give hidden visibility to inlined class member functions
    -std=gnu++17                    # Use the C++17 language standard including GNU extensions
    -Wno-narrowing                  # Don't warn about type narrowing
    -Wsign-compare                  # Warn about mixed signed/unsigned type comparisons
    )
  list(APPEND COMMON_COMPILER_FLAGS_DEBUG
...
if(OS_WINDOWS)
  ...
  list(APPEND COMMON_COMPILER_FLAGS
    ...
    #/GR-          # Disable run-time type information, 启用运行时类型信息，以便类似dynamic_pointer_cast之类的动态类型转换
    /W4           # Warning level 4
    ...
    /wd4456       # Ignore "" warning
    /wd4819       # Ignore "" warning
    /wd4245       # Ignore "" warning
    /wd4324       # Ignore "" warning
