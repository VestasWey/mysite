...
MenuItemView* MenuController::FindNextSelectableMenuItem(
    ...
    SelectionIncrementDirectionType direction,
    bool is_initial) {
  int parent_count = int{ (int)parent->GetSubmenu()->GetMenuItems().size()};
