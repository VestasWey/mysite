...
namespace mctm
{
        ...
        size_t size_element)
    {
        ...
        __int64 num_bytes = static_cast<__int64>(num_elements) * size_element;
        int num_bytes32 = static_cast<int>(num_bytes);
        if (num_bytes != static_cast<__int64>(num_bytes32))
            return NULL;
    ...
    bool PickleIterator::ReadUInt16(unsigned short* result)
    {
        return ReadBuiltinType(result);
    }
    ...
    bool PickleIterator::ReadInt64(__int64* result)
    {
        return ReadBuiltinType(result);
    }

    bool PickleIterator::ReadUInt64(unsigned __int64* result)
    {
        return ReadBuiltinType(result);
    }
    ...
    char* Pickle::BeginWrite(size_t length)
    {
        ...
        size_t offset = AlignInt(header_->payload_size, sizeof(unsigned int));
    ...
    void Pickle::EndWrite(char* dest, int length)
    {
        ...
        if (length % sizeof(unsigned int))
            memset(dest + length, 0, sizeof(unsigned int) - (length % sizeof(unsigned int)));
    }
