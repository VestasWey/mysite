...
namespace mctm
{
    ...
    public:
        ...
        virtual bool Read();
        virtual bool Write(const char* data, unsigned long len);
        virtual void Close();
    ...
    public:
        ...
        bool Start();
        bool Send(ULONG_PTR client_key, const char* data, unsigned long len);
        void Stop();
    ...
    public:
        ...
        // must be called on io thread
        bool Connect();
        bool Send(const char* data, unsigned long len);
