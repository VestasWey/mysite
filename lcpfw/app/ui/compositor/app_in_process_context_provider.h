...
namespace ui {
    ...
    class AppInProcessContextProvider
        : public base::RefCountedThreadSafe<AppInProcessContextProvider>,
        public viz::ContextProvider,
        public viz::RasterContextProvider {
    public:
        static scoped_refptr<AppInProcessContextProvider> Create(
        ...
        static scoped_refptr<AppInProcessContextProvider> CreateOffscreen(
            gpu::GpuMemoryBufferManager* gpu_memory_buffer_manager,
            gpu::ImageFactory* image_factory,
            bool support_locking);
    ...
    private:
        friend class base::RefCountedThreadSafe<AppInProcessContextProvider>;

        AppInProcessContextProvider(
            const gpu::ContextCreationAttribs& attribs,
            gpu::GpuMemoryBufferManager* gpu_memory_buffer_manager,
            gpu::ImageFactory* image_factory,
            gpu::SurfaceHandle window,
            const std::string& debug_name,
            bool support_locking);
        ~AppInProcessContextProvider() override;
        ...
        DISALLOW_COPY_AND_ASSIGN(AppInProcessContextProvider);
    };
