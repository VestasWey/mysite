...
class GpuMemoryBufferImpl : public gfx::GpuMemoryBuffer {
 public:
  GpuMemoryBufferImpl(AppGpuMemoryBufferManager* manager,
                      int id,
                      const gfx::Size& size,
 ...
 private:
  AppGpuMemoryBufferManager* manager_;
...
class GpuMemoryBufferFromClient : public gfx::GpuMemoryBuffer {
 public:
  GpuMemoryBufferFromClient(AppGpuMemoryBufferManager* manager,
                            int id,
...
AppGpuMemoryBufferManager::AppGpuMemoryBufferManager() {}
...
AppGpuMemoryBufferManager::CreateClientGpuMemoryBufferManager() {
  base::AutoLock hold(lock_);
  std::unique_ptr<AppGpuMemoryBufferManager> client(
      new AppGpuMemoryBufferManager);
...
void AppGpuMemoryBufferManager::OnGpuMemoryBufferDestroyed(
...
AppGpuMemoryBufferManager::CreateGpuMemoryBuffer(
    const gfx::Size& size,
    gfx::BufferFormat format,
...
void AppGpuMemoryBufferManager::SetDestructionSyncToken(
    gfx::GpuMemoryBuffer* buffer,
    const gpu::SyncToken& sync_token) {}

void AppGpuMemoryBufferManager::CopyGpuMemoryBufferAsync(
...
bool AppGpuMemoryBufferManager::CopyGpuMemoryBufferSync(
    gfx::GpuMemoryBufferHandle buffer_handle,
    base::UnsafeSharedMemoryRegion memory_region) {
  return false;
}
