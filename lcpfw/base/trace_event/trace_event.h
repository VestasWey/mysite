...
#else
    static unsigned char arg_types[1] = {6};
    static unsigned long long arg_values = -1;
    base::trace_event::TraceArguments args(1, (const char* const*)arg1_name, arg_types, &arg_values);
#endif
...
AddTraceEventWithThreadIdAndTimestamp(
  ...
  base::trace_event::TraceArguments args(
    ...
    static unsigned char arg_types[2] = { 6,6 };
    static unsigned long long arg_values[2] = { -1, -1 };
    base::trace_event::TraceArguments args(2, arg_names, arg_types, arg_values);
#endif
  return TRACE_EVENT_API_ADD_TRACE_EVENT_WITH_THREAD_ID_AND_TIMESTAMP(
      phase, category_group_enabled, name, scope, id, bind_id, thread_id,
      timestamp, &args, flags);
